...
%Plotting
    ...
    function states = swing(T,Z)
        ...
        stuff = [0; -m1*l1/2*td1^2*cos(t1); m1*g + m1*l1/2*td1^2*sin(t1); l1/2*m1*g*sin(t1); -m2*(l1*td1^2*cos(t1) + l2/2*td2^2*cos(t2)); m2*g + m2*(l1*td1^2*sin(t1) + l2/2*td2^2*sin(t2));  0 ];
